    ...
    <body>
                    ...
                    <div class="grid invoice">
                        <div class="grid-body">
                            <div class="invoice-title order_process_complete_fade">
                                <div class="row m-t-30">
                                    <div class="col-12" style="background: url('admin/product_image/banner5.jpg') center/cover no-repeat;display: flex;width: 100%;height: 100px;">
                            ...
                            <br>
                            <div class="col-xs-12 col-md-12 col-lg-12 m-t-30 text-center order_process_complete_fade">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $.post("includes/cart/cart_process.php", {
                    "checkout_amount": "1"
                }, function(total) {
