                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 cart-image">
                                <img src="admin/product_image/<?php echo $product_image; ?>" style="float: right"
                                     height='170px'>
                            </div>
                            <div class="col-xs-10 col-md-10 col-sm-10 col-lg-10  cart-details">
                                <table class="table table-borderless ">
                                    ...
                                    <tr>
                                        <td style='font-size:16px;'
                                            class='cart-table'> <?php echo $product_name . ' ' . $product_desc; ?></td>
                                        <td class="cart-table">
                                            <div>
                                                <form class="increment-item" method="post"
                                                      action="includes/cart/cart_process.php">
                                                    <input name='increment_id' type='hidden'
                                                           value='<?php echo $product_id; ?>'>
                                                    <button class="item_count_btn" type="submit"><i
                                                            class="fas fa-chevron-up"></i></button>
                                                </form>
                                                <p class='item-amount item_subtotal_qty'><?php echo $product_qty; ?></p>
                                                <form class="decrement-item" method="post"
                                                      action="includes/cart/cart_process.php">
                                                    <input name='decrement_id' type='hidden'
                                                           value='<?php echo $product_id; ?>'>
                                                    <button class="item_count_btn" type="submit"><i
                                ...
                                <div style="text-align: left;" class="cart-remove-button">
                                    <a href="#" class="remove-cartpage-item text-decoration-none"
                                       data-code="<?php echo $product_id; ?>"><i
                                            class='fas fa-trash fa-sm trash-icon'></i> Remove</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-10 col-md-10 col-sm-10 col-lg-10  cart-details">
                ...
                <button class="btn btn-md" style="outline-color: #61a8c7; border:1px;">
                    <span style="font-weight: bolder; font-size: 30px;">Total Amount</span>: <h4
                        style="font-weight: bold" class="total_cart_amount"><?php echo $currency . $total; ?></h4>
                </button>
